...
const [userData, SetUserData] = useState(PaymentDetails)

const {
    name,contact,departure,destination,
    roomType,email,people
} = userData;
...
<Flex w="90%" m="auto" mt="56px">
    ...
    <Flex
            ...
            <Stack spacing={8} mx={'auto'} maxW={'lg'} borderRadius="6px" py={6} px={6} border="1px solid #6F8CB3">
            <Stack align={'center'}>
