    ...
    <>
      <Box w={"90%"} m={"auto"}>
        <Box w={"100%"}>
          <Image
            w="98%"
            src="https://cdn1.tripoto.com/media/transfer/img/1789711/Image/1656336375_offbeat_places_2_1.gif"
            borderRadius="md"
            mt={"24px"}
          />
        </Box>
        ...
        >
          ...
          articles. Here are the most promising creators of the month who shared
          their favorite Winter Experiences with us. Kudos to Tripoto's best
          creators for Nov 2022!
        </Text>
